				...
				<div class="card">
					<div class="card-body">
						<div class="card-title d-flex align-items-center">
							...
							<h6>NEW SURVEY FORM</h6>
						</div>
						<hr>
						<form class="row g-2" method="post" action="{{ route('newserveupdate') }}" enctype="multipart/form-data">
							@csrf
							...
							<div class="col-md-6" >
								...
								<input class="form-control " type="text" placeholder="Survey Application No."
									aria-label="default input example" name ="survey_app_no" value="{{ $edit_data->survey_app_no}}">
							...
							<div class="col-md-6" >
								...
								<input class="form-control from-text " type="text" placeholder="Name of Establishment"
									aria-label="default input example" name="establishment" value="{{ $edit_data->establishment}}">
							...
							<div class="col-md-6">
								...
								<input class="form-control from-text " type="text" placeholder="Name of Business Owner"
									aria-label="default input example" name="bussiness_owner" value="{{ $edit_data->bussiness_owner}}">
							</div>
								<div class="col-md-6">
								<label class="form-label"></label>
							...
							<div class="col-md-6">
								...
								<input class="form-control from-text mb-3" type="text" placeholder="Building Name"
									aria-label="default input example" name="bulding" value="{{ $edit_data->bulding}}" >
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								...
								<input class="form-control  from-text mb-3" type="text" placeholder="Lane/Street Name"
									aria-label="default input example" name="street_name" value="{{ $edit_data->street_name}}" >
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control to-text  mb-3" type="text" placeholder="लेन रस्त्याचे नाव"
									aria-label="default input example" style="margin-top:8px;" name="street_name1" value="{{ $edit_data->street_name1}}">
							</div>
								<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<input class="form-control from-text mb-3" type="text" placeholder="Prabhag Name"
									aria-label="default input example" name="prabhag_name" value="{{ $edit_data->prabhag_name}}">
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control to-text mb-3" type="text" placeholder="प्रभाग नाव"
									aria-label="default input example" style="margin-top:8px;" name="prabhag_name1" value="{{ $edit_data->prabhag_name1}}">
							</div>
							<div class="col-md-6">
								<label class="form-label">Zone No.</label>								
								<input class="form-control from-text mb-3" type="text" placeholder="Zone No."
									aria-label="default input example" name="zone_no" value="{{ $edit_data->zone_no}}">
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control to-text mb-3" type="text" placeholder="झोन क्र."
									aria-label="default input example" style="margin-top:8px;" name="zone_no1" value="{{ $edit_data->zone_no1}}">
							</div>

                           	<div class="col-md-6">
								<label class="form-label">Pin Code</label>								
								<input class="form-control from-text mb-3" type="text" placeholder="Pin Code"
									aria-label="default input example" name="pincode" value="{{ $edit_data->pincode}}">
							</div>
							 	<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control to-text mb-3" type="text" placeholder="पिन कोड"
									aria-label="default input example" style="margin-top:8px;" name="pincode1" value="{{ $edit_data->pincode1}}">
							</div>
							...
							<div class="col-md-6">
								...
								<input class="form-control from-text mb-3" type="text" placeholder="Email ID"
									aria-label="default input example" name="email" value="{{ $edit_data->email}}" >
							</div>
								<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control  to-text mb-3" type="text" placeholder="ईमेल आयडी"
									aria-label="default input example" style="margin-top:8px;" name="email1" value="{{ $edit_data->email1}}">
							</div>

							<div class="col-md-6">
								<label class="form-label">Whatsapp No</label>								
								<input class="form-control  from-text mb-3" type="text" placeholder="Whatsapp No."
									aria-label="default input example" name="wht_app_no" value="{{ $edit_data->wht_app_no}}">
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control to-text mb-3" type="text" placeholder="व्हॉट्सअॅप नंबर"
									aria-label="default input example" style="margin-top:8px;" name="wht_app_no1" value="{{ $edit_data->wht_app_no1}}">
							</div>

							<div class="col-md-6">
								<label class="form-label">GST No</label>								
								<input class="form-control from-text mb-3" type="text" placeholder="GST"
									aria-label="default input example" name="gst_no" value="{{ $edit_data->gst_no}}">
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control to-text mb-3" type="text" placeholder="जीएसटी नंबर"
									aria-label="default input example" style="margin-top:8px;" name="gst_no1" value="{{ $edit_data->gst_no1}}">
							</div>
							...
							<div class="col-md-6">
								...
								<select class="form-select from-text mb-3" aria-label="Default select example"
									...
									@endforeach
									<option value="Hotel"  @if($edit_data->type_of_bussiness_id=="Hotel") selected @endif>Hotel</option>
							...
							<div class="row" id="other_hotel">
								...
								<div class="col-md-3">
									...
									<input class="form-control from-text mb-3" type="text" placeholder="No Of Ac Room"
										...
										name="ac_room" id="other6" value="{{ $edit_data->ac_room}}">
								</div>
								...
								<div class="col-md-3">
									...
									<input class="form-control to-text mb-3" type="text" placeholder="एसी रूमची संख्या "
										...
										id="other16" value="{{ $edit_data->ac_room1}}">
								...
								<div class="col-md-3">
									...
									<input class="form-control from-text mb-3" type="text" placeholder="No Of Non Ac Room "
										aria-label="default input example" style="margin-top:8px;"
										name="non_ac_room" id="other36" value="{{ $edit_data->non_ac_room}}">
								</div>
								...
								<div class="col-md-3">
									...
									<input class="form-control to-text mb-3" type="text" placeholder="नॉन एसी रूमची संख्या "
										aria-label="default input example" style="margin-top:8px;"
										name="non_ac_room1" id="other366" value="{{ $edit_data->non_ac_room1}}">
								</div>
								{{-- <div class="col-md-3">
									<label class="form-label">No Of Non Ac Room</label>
									<input class="form-control to-text mb-3" type="text" placeholder="नॉन एसी रूमची संख्या "
...
{{-- @json($ty_licence) --}}
							...
							<div class="col-md-6">
								...
								<select class="form-select from-text mb-3"
									...
									<option value="">Select</option>
									@foreach ($ty_licence as $ty_licence)
										<option value="{{ $ty_licence->id }}" @if($edit_data->type_of_licence_id==$ty_licence->id) selected @endif>{{ $ty_licence->bussiness_reg_type }}
										</option>
									@endforeach
							...
							<div class="row" id="other_div">
								...
								<div class="col-md-6">
									...
									<input class="form-control from-text mb-3" type="text" placeholder="License Name "
										aria-label="default input example" style="margin-top:8px;"
										name="licence_name" id="other" value="{{ $edit_data->licence_name}}">
								</div>
								...
								<div class="col-md-6">
									...
									<input class="form-control to-text mb-3" type="text" placeholder="लायसन्सचे नाव "
										...
										id="other1" value="{{ $edit_data->licence_name1}}">
							...
							<div class="row" id="other_div"> --}}
								...
								<div class="col-md-6">
									...
									<input class="form-control from-text mb-3" type="text" placeholder="License No "
										aria-label="default input example" style="margin-top:8px;"
										name="licence_no" id="other3" value="{{ $edit_data->licence_no}}">
								</div>
								...
								<div class="col-md-6">
									...
									<input class="form-control to-text mb-3" type="text" placeholder="लायसन्सचे क्रमांक "
										...
										id="other4" value="{{ $edit_data->licence_no1}}">
							...
							<div class="col-md-6">
								...
								<input class="form-control from-text mb-3" type="text" placeholder="Number of Employees Working as on date"
									aria-label="default input example" name="no_of_employee_working" value="{{ $edit_data->no_of_employee_working}}">
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control to-text mb-3" type="text" placeholder="आजपर्यंत काम करणाऱ्या कर्मचाऱ्यांची संख्या"
									aria-label="default input example" style="margin-top:8px;" name="no_of_employee_working1" value="{{ $edit_data->no_of_employee_working1}}">
							</div>

                           
							<div class="col-md-6">
								<label class="form-label">Area of Business in square Feet</label>								
								<input class="form-control from-text mb-3" type="text" placeholder="Area of Business in square Feet"
									aria-label="default input example"  name="area_of_bussiness" value="{{ $edit_data->area_of_bussiness}}">
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control to-text mb-3" type="text" placeholder="व्यवसायाचे क्षेत्रफळ चौरस फुटात"
									aria-label="default input example" style="margin-top:8px;" name="area_of_bussiness1" value="{{ $edit_data->area_of_bussiness1}}">
							</div>
							<div class="col-md-6">
								...
								<input class="form-control mb-3" type="text" placeholder="Year of starting of Business"
									aria-label="default input example" name="year"  value="{{ $edit_data->year}}">
							</div> 
