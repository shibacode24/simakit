                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-2" method="post" action="{{ route('newserveinsert') }}"
								...
								<input class="form-control from-text mb-3" type="text" placeholder="Nature of Business"
									aria-label="default input example"  name="nature_of_bussiness">
							</div>
							<div class="col-md-6">
								<label class="form-label"></label>								
								<input class="form-control  to-text mb-3" type="text" placeholder="व्यवसायाचे स्वरूप"
									aria-label="default input example" style="margin-top:8px;" name="nature_of_bussiness1">
							</div> --}}
                                <div class="col-md-6">
...
$(document).on('change', '.bussiness_id', function() {
	if ($(this).val() == '5') {
		//$("#select_service").hide();
		$("#other_div").show();
	}
