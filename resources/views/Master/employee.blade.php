			...
			<div class="page-content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<hr>
						<form class="row g-2" method="post"   enctype="multipart/form-data" action="{{ route('employeeinsert') }}">
							@csrf
							...
							<div class="col-md-3">
								<label for="inputAddress" class="form-label" required>Address</label>
										<textarea class="form-control" id="inputAddress"  name="address" placeholder="Address..." rows="1"></textarea>
							</div>
