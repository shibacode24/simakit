			...
			<div class="row">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<hr>
						<form class="row g-2" method="post" action="{{ route('bussinessupdate') }}">
							@csrf
							...
							<div class="col-md-4">
								...
								<input class="form-control mb-3 from-text" type="text" placeholder="Business Registration" name="bussiness_reg_type" value="{{ $edit_data->bussiness_reg_type }}">
								
							</div>
							<div class="col-md-4">
								<label>Business Reg.Type</label>
								<input class="form-control mb-3 to-text" type="text" placeholder="Business Registration" name="bussiness_reg_type1" value="{{ $edit_data->bussiness_reg_type1 }}">
