					...
					<div class="card-body">
						...
						<form class="row g-2" method="post" action="{{ route("typeofbussinessupdate") }}">
							...
							<div class="col-md-4">
								...
								<input class="form-control mb-3 from-text" type="text" name="bussiness_type"placeholder="Business Type" value="{{ $edit_data->bussiness_type }}">
							...
							<div class="col-md-4">
								...
								<input class="form-control to-text mb-3" type="text" name="bussiness_type1" placeholder="व्यवसायाचे प्रकार" value="{{ $edit_data->bussiness_type1 }}">
							</div>

								<div class="col-md-4">
								<label>Charges of Municipal Corporation</label>
								<input class="form-control mb-3" type="text" name="charges" placeholder="Charges" value="{{ $edit_data->charges }}">
							...
							<table id="example" class="table table-striped table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{ $all->charges }}</td>	
										<td>	<a href="{{ route('typeofbussinessedit',$all->id) }}"><button type="button" class="btn1 btn-outline-success"><i class='bx bx-edit-alt me-0'></i></button></a> 
