...
<head>
	...
	<title>	NANDED WAGHALA CITY MUNICIPAL CORPORATION</title>
</head>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="{{ asset('images/mc-logo.png')}}" class="logo-icon" alt="logo icon">
				</div>
				<div>
					<p class="logo-text">
			...
			<ul class="metismenu" id="menu">
				...
				<div class="menu-title">Master</div>
					...
					<ul>
						<li> <a href="{{ route('corporation') }}"><i class="bx bx-right-arrow-alt"></i>Corporation Master </a>
						</li>
						<li> <a href="{{ route('city') }}"><i class="bx bx-right-arrow-alt"></i>City Master </a>
						</li>
						<li> <a href="{{ route('employee') }}"><i class="bx bx-right-arrow-alt"></i>Employee Master </a>
						</li>
						<li> <a href="{{ route('typeofbussiness') }}"><i class="bx bx-right-arrow-alt"></i>Type of Business </a>
						</li>
						<li> <a href="{{ route('bussiness') }}"><i class="bx bx-right-arrow-alt"></i>Business Reg.Type</a>
						</li>
						{{-- <li> <a href="{{ route('typeoflicence') }}"><i class="bx bx-right-arrow-alt"></i> Licence Type</a>
						</li> --}}
						</ul>
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						<div class="parent-icon"><i class="lni lni-user" style="font-size: 17px;"></i></i>
						</div>
				<div class="menu-title">Survey Form</div>
					</a>
					<ul>
						<li> <a href="{{ route('newserve') }}"><i class="bx bx-right-arrow-alt"></i>New Survey From</a>
						</li>
						<li> <a href="{{ route('existingserve') }}"><i class="bx bx-right-arrow-alt"></i>Existing Survey From</a>
						</li>
						
						<li> <a href="{{ route('showserve') }}"><i class="bx bx-right-arrow-alt"></i>Show Survey Form</a>
						</li>
